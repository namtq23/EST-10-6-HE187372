...
final fetchUsersListProvider = FetchUsersListProvider._();

final class FetchUsersListProvider extends $FunctionalProvider<
        AsyncValue<List<User>>, List<User>, FutureOr<List<User>>>
    with $FutureModifier<List<User>>, $FutureProvider<List<User>> {
  FetchUsersListProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$fetchUsersListHash();
